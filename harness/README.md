...
- `harness/feature-ledger.json`: source of truth for what is verified, next up, or still planned
...
6. Update `harness/feature-ledger.json` and append a short note to `harness/progress.md`.
7. Commit the session in a clean, reviewable state.

## Guardrails

- Do not delete or reorder features casually. Add context in `notes` instead.
